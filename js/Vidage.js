(function(f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.Vidage = f() } })(function() {
    ...
    return (function e(t, n, r) {
        ...
        }, { "./helpers/feature-detect": 5, "./helpers/handle-video-selector": 6, "./helpers/validate-selector": 7, "debounce": 2, "object-assign": 3 }],
